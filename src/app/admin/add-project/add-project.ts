      ...
      <div class="container mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div class="max-w-2xl mx-auto">
          ...
          <div class="mb-6 sm:mb-8">
            <h1 [class]="isDark() ? 'text-2xl sm:text-3xl font-bold text-white mb-2' : 'text-2xl sm:text-3xl font-bold text-gray-900 mb-2'">Add New Project</h1>
            <p [class]="isDark() ? 'text-sm sm:text-base text-gray-400' : 'text-sm sm:text-base text-gray-600'">Create a new project for your portfolio</p>
          </div>

          <!-- Form -->
          <form [class]="isDark() ? 'bg-gray-800 p-4 sm:p-6 rounded-lg' : 'bg-white p-4 sm:p-6 rounded-lg shadow-md'" (ngSubmit)="onSubmit()">
            <!-- Title -->
            <div class="mb-6">
            ...
            <div class="mb-6">
              ...
              @if (imagePreviews.length > 0) {
                <div class="mt-4">
                  <h4 [class]="isDark() ? 'text-sm font-medium text-white mb-2' : 'text-sm font-medium text-gray-700 mb-2'">Selected Images:</h4>
                  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button 
                ...
                class="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white px-6 py-2 rounded-lg font-semibold transition-colors flex-1 sm:flex-none"
              >
              ...
              <button 
                type="button" 
                (click)="goBack()"
                [class]="isDark() ? 'bg-gray-700 hover:bg-gray-600 text-white px-6 py-2 rounded-lg font-semibold transition-colors flex-1 sm:flex-none' : 'bg-gray-200 hover:bg-gray-300 text-gray-900 px-6 py-2 rounded-lg font-semibold transition-colors flex-1 sm:flex-none'"
              >
                Cancel
              </button>
            </div>
  ...
  async onSubmit() {
    ...
    try {
      ...
      if (this.imagePreviews.length > 0) {
        ...
        // If no images selected, ensure images array is empty
        this.project.images = [];
      }
      
      console.log('Project data before saving:', this.project);
      await this.projectsService.addProject(this.project);
